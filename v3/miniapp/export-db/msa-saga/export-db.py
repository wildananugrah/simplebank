...
db_accounts = list(client_account.simplebank_db.accounts.find({}, {'_id' : False}))
db_transactions = list(client_transaction.simplebank_db.transactions.find({}, {'_id' : False}))
db_historical_transactions = list(client_hist.simplebank_db.historical_transactions.find({}, {'_id' : False}))
db_payments = list(client_payment.simplebank_db.payments.find({}, {'_id' : False}))
db_interbank_transfer = list(client_interbank_transfer.simplebank_db.interbank_transfers.find({}, {'_id' : False}))
