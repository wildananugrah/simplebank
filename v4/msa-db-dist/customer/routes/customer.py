from controller.customer import customer_detail, customer_mobile_login, customer_interbank_banking_login, customer_logout
...
def interbank_banking_login():
    return customer_interbank_banking_login(request.get_json())
