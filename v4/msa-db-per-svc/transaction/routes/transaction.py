from controller.transaction import transaction_detail, transaction_deposit, transaction_list, transaction_intrabank_transfer, transaction_debit, transaction_reversal
...
def reversal():
    return transaction_reversal(json_request)
