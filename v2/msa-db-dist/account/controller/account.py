...
class AccountController():
    ...
    #         return self.view.detail({ 'message' : "From account number is not found!", "transaction_id" : transaction_id }, status_code=400)

    #     if not db_to_account_number:
    #         return self.view.detail({ 'message' : "To account number is not found!", "transaction_id" : transaction_id }, status_code=400)
